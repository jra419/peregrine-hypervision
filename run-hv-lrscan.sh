...
for i in $(seq $COUNT); do
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/dns_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/dns_lrscan/dns_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/dns_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/dns_lrscan/dns_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/http_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/http_lrscan/http_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/http_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/http_lrscan/http_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/icmp_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/icmp_lrscan/icmp_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/icmp_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/icmp_lrscan/icmp_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/netbios_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/netbios_lrscan/netbios_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/netbios_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/netbios_lrscan/netbios_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/rdp_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/rdp_lrscan/rdp_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/rdp_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/rdp_lrscan/rdp_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/smtp_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/smtp_lrscan/smtp_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/smtp_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/smtp_lrscan/smtp_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/snmp_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/snmp_lrscan/snmp_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/snmp_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/snmp_lrscan/snmp_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/ssh_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/ssh_lrscan/ssh_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/ssh_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/ssh_lrscan/ssh_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/telnet_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/telnet_lrscan/telnet_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/telnet_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/telnet_lrscan/telnet_lrscan-4096-$DATETIME.log"
	...
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/vlc_lrscan-2048.json cp | tee "eval/logs/hypervision/lrscan/vlc_lrscan/vlc_lrscan-2048-$DATETIME.log"
	sudo -E ./build/debug/hypervision conf/hypervision/lrscan/vlc_lrscan-4096.json cp | tee "eval/logs/hypervision/lrscan/vlc_lrscan/vlc_lrscan-4096-$DATETIME.log"
done
