#include "edge_constructor_new.hpp"

using namespace hypervision;

void edge_constructor::flow_classification(raw_flow_vec & short_flow_pvec,
										   raw_flow_vec & long_flow_pvec) {
