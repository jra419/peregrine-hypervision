...
struct sample_t {
	...
	sample_t(std::array<std::string, 56> hv_hdr,
		...
		ts_start_0	= std::stoi(hv_hdr[0]);
		ts_end_0	= std::stoi(hv_hdr[1]);
		ts_agg_0	= std::stoi(hv_hdr[2]);
		ip_src_0	= std::stoi(hv_hdr[3]);
		ip_dst_0	= std::stoi(hv_hdr[4]);
		proto_0		= std::stoi(hv_hdr[5]);
		ports_0		= std::stoi(hv_hdr[6]);
		...
		ts_start_1	= std::stoi(hv_hdr[14]);
		ts_end_1	= std::stoi(hv_hdr[15]);
		ts_agg_1	= std::stoi(hv_hdr[16]);
		ip_src_1	= std::stoi(hv_hdr[17]);
		ip_dst_1	= std::stoi(hv_hdr[18]);
		proto_1		= std::stoi(hv_hdr[19]);
		ports_1		= std::stoi(hv_hdr[20]);
		...
		ts_start_2	= std::stoi(hv_hdr[28]);
		ts_end_2	= std::stoi(hv_hdr[29]);
		ts_agg_2	= std::stoi(hv_hdr[30]);
		ip_src_2	= std::stoi(hv_hdr[31]);
		ip_dst_2	= std::stoi(hv_hdr[32]);
		proto_2		= std::stoi(hv_hdr[33]);
		ports_2		= std::stoi(hv_hdr[34]);
		...
		ts_start_3	= std::stoi(hv_hdr[42]);
		ts_end_3	= std::stoi(hv_hdr[43]);
		ts_agg_3	= std::stoi(hv_hdr[44]);
		ip_src_3	= std::stoi(hv_hdr[45]);
		ip_dst_3	= std::stoi(hv_hdr[46]);
		proto_3		= std::stoi(hv_hdr[47]);
		ports_3		= std::stoi(hv_hdr[48]);
