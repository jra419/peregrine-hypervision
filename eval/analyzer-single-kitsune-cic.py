...
def roc_action(label: List[int], score: List[float]) -> void:
    ...
    if not os.path.exists(f'./figure/{args.dataset}/{args.target}'):
        os.mkdir(f'./figure/{args.dataset}/{args.target}')

    plt.savefig(f'./figure/{args.dataset}/{args.target}/{args.file_name}-auc-roc.png')
    ...
    print(f"[{args.dataset}-{args.target}]")
    ...
    if not os.path.exists(f'./metrics/{args.dataset}/{args.target}'):
        os.mkdir(f'./metrics/{args.dataset}/{args.target}')

    f = open(f'./metrics/{args.dataset}/{args.target}/{args.file_name}-roc.txt', 'a+')
    f.write(f'[{args.dataset}-{args.target}]\n')
...
def f_action(label: List[int], score: List[float]) -> void:
    ...
    plt.savefig(f'./figure/{args.dataset}/{args.target}/{args.file_name}-auc-prc.png')
    ...
    f = open(f'./metrics/{args.dataset}/{args.target}/{args.file_name}-prc.txt', 'a+')
    f.write(f'[{args.dataset}-{args.target}]\n')
